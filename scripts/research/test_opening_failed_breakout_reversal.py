...
VARIANTS = {
    ...
    "both_or15_fail_rr15_vwap": {
        "direction": "both",
        "or_end": "09:45",
        "max_bars_after_breakout": 8,
        "breakout_buffer_atr": 0.03,
        "reentry_buffer_atr": 0.01,
        "stop_mode": "breakout_extreme",
        "min_rr": 1.5,
        "require_volume_confirm": True,
        "vol_mult": 1.00,
...
def evaluate_trades(
    ...
    row = {
        "symbol": symbol,
        "timeframe": timeframe,
        "strategy_family": "opening_failed_breakout_reversal",
        "variant": variant,
...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    safe = f"{args.symbol.upper()}_{args.timeframe}_{args.exit_policy}_opening_failed_breakout_reversal"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Opening Failed Breakout / ORB Trap Reversal diagnostic runner.")
    ...
    parser.add_argument("--output-dir", default="outputs/research/opening_failed_breakout_reversal")
