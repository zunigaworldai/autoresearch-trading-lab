...
from strategies.rsi_bollinger_mean_reversion import DEFAULT_PARAMS, generate_signals
...
VARIANTS = {
    ...
    "both_rsi30_70_bb25_mid_swing": {
        ...
        "rsi_oversold": 30.0,
        "rsi_overbought": 70.0,
        "confirm_mode": "reversal_candle",
        "stop_mode": "swing",
        "target_mode": "midband",
        "min_rr": 1.0,
    },
    "both_rsi30_70_bb20_vwap_atr": {
        "direction": "both",
        "bb_len": 20,
        "bb_mult": 2.0,
        "rsi_len": 14,
        ...
        "target_mode": "vwap",
        "min_rr": 1.0,
        "require_vwap_side_filter": True,
    },
    "both_rsi30_70_bb20_rr15_atr": {
        "direction": "both",
        "bb_len": 20,
        "bb_mult": 2.0,
        "rsi_len": 14,
...
ENTRY_WINDOWS = {
    "open_0930_1030": ("09:30", "10:30"),
    "open_0930_1130": ("09:30", "11:30"),
    ...
    "rth_full_0930_1600": ("09:30", "16:00"),
}
...
def evaluate_trades(
    ...
    row = {
        "symbol": symbol,
        "timeframe": timeframe,
        "strategy_family": "rsi_bollinger_mean_reversion",
        "variant": variant,
...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    safe = f"{args.symbol.upper()}_{args.timeframe}_{args.exit_policy}_rsi_bollinger_mean_reversion"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="RSI + Bollinger Bands Mean Reversion diagnostic runner.")
    ...
    parser.add_argument(
        "--entry-windows",
        nargs="+",
        default=["open_0930_1030", "mid_1000_1130", "late_morning_1030_1200", "midday_1100_1300", "afternoon_1300_1500", "power_1400_1600"],
    ...
    parser.add_argument("--output-dir", default="outputs/research/rsi_bollinger_mean_reversion")
