...
from strategies.vwap_mean_reversion import DEFAULT_PARAMS, generate_signals
...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    safe = f"{args.symbol.upper()}_{args.timeframe}_{args.exit_policy}_vwap_mean_reversion"
    ...
    report = {
        ...
        "warning": "Diagnostic only. Must pass full cost stress, OOS, walk-forward, and portfolio checks before paper/live.",
    }
...
def main() -> None:
    parser = argparse.ArgumentParser(description="VWAP Mean Reversion diagnostic runner.")
    ...
    parser.add_argument(
        "--variants",
        nargs="+",
        default=["both_atr15_vwap_atrstop", "both_atr20_vwap_atrstop", "long_atr15_vwap_atrstop", "short_atr15_vwap_atrstop"],
    ...
    parser.add_argument("--output-dir", default="outputs/research/vwap_mean_reversion")
