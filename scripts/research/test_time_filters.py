...
DEFAULT_WINDOWS = [
    ...
    ("10:00", "12:00", "mid_1000_1200"),
    ("11:00", "13:00", "midday_1100_1300"),
    ("12:00", "14:00", "midday_1200_1400"),
    ("13:00", "15:30", "pm_1300_1530"),
]
    ...
    for raw in raw_windows:
        ...
        if len(parts) != 3:
            raise SystemExit(
                ...
                "Example: --window open_0930_1100,09:30,11:00"
            )
...
def run_window_cost(
    ...
    base = f"{symbol}_{timeframe}_{strategy}_{exit_policy}_{safe_label}_{cost_label}"
...
def run_experiment(
    ...
    for session_start, session_end, label in windows:
    ...
    matrix_path = output_dir / f"{symbol}_{timeframe}_{exit_policy}_time_filter_matrix.csv"
    report_path = output_dir / f"{symbol}_{timeframe}_{exit_policy}_time_filter_report.json"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run time-of-day filter experiments")
    ...
    parser.add_argument(
        "--output-dir",
        default="outputs/research/time_filters",
