...
from strategies.opening_drive_continuation import DEFAULT_PARAMS, generate_signals
...
VARIANTS = {
    "both_drive15_breakout_rr15_atr": {
        "direction": "both",
        "drive_end": "09:45",
        "entry_mode": "breakout",
        "stop_mode": "atr",
    ...
    "long_drive15_breakout_rr15_atr": {
        "direction": "long",
        "drive_end": "09:45",
        "entry_mode": "breakout",
        "stop_mode": "atr",
    ...
    "short_drive15_breakout_rr15_atr": {
        "direction": "short",
        "drive_end": "09:45",
        "entry_mode": "breakout",
        "stop_mode": "atr",
    ...
    "both_drive30_breakout_rr15_atr": {
        "direction": "both",
        "drive_end": "10:00",
        "entry_mode": "breakout",
        "stop_mode": "atr",
    ...
    "both_drive15_hold_rr15_atr": {
        "direction": "both",
        "drive_end": "09:45",
        "entry_mode": "two_bar_hold",
        "stop_mode": "atr",
        "atr_stop_mult": 1.0,
        "min_rr": 1.5,
        "require_volume_confirm": True,
    ...
    "both_drive15_breakout_rr15_drive_stop": {
        "direction": "both",
        "drive_end": "09:45",
        "entry_mode": "breakout",
        "stop_mode": "drive_opposite",
        "min_rr": 1.5,
        "require_volume_confirm": True,
        "vol_mult": 1.10,
        "require_ema_alignment": True,
    ...
    "both_drive15_breakout_rr15_no_vwap": {
        "direction": "both",
        "drive_end": "09:45",
        "entry_mode": "breakout",
        "stop_mode": "atr",
...
def evaluate_trades(
    ...
    row = {
        "symbol": symbol,
        "timeframe": timeframe,
        "strategy_family": "opening_drive_continuation",
        "variant": variant,
...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    safe = f"{args.symbol.upper()}_{args.timeframe}_{args.exit_policy}_opening_drive_continuation"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Opening Drive Continuation diagnostic runner.")
    ...
    parser.add_argument("--output-dir", default="outputs/research/opening_drive_continuation")
