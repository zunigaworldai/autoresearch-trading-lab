...
from strategies.gap_continuation_fade import DEFAULT_PARAMS, generate_signals
...
VARIANTS = {
    "both_gap_cont_drive15_rr15_atr": {
    ...
    "long_gap_up_cont_drive15_rr15_atr": {
        "gap_mode": "continuation",
        "direction": "long",
        "drive_end": "09:45",
        "min_gap_pct": 0.0030,
    ...
    "short_gap_down_cont_drive15_rr15_atr": {
        "gap_mode": "continuation",
        "direction": "short",
        "drive_end": "09:45",
        "min_gap_pct": 0.0030,
    ...
    "both_gap_fade_drive15_rr15_atr": {
        "gap_mode": "fade",
        "direction": "both",
        "drive_end": "09:45",
        "min_gap_pct": 0.0030,
        "max_gap_pct": 0.0300,
        "require_drive_direction": False,
        "stop_mode": "atr",
        "atr_stop_mult": 1.0,
        "min_rr": 1.5,
        "require_volume_confirm": True,
    ...
    "long_gap_down_fade_drive15_rr15_atr": {
        "gap_mode": "fade",
        "direction": "long",
        "drive_end": "09:45",
        "min_gap_pct": 0.0030,
    ...
    "short_gap_up_fade_drive15_rr15_atr": {
        "gap_mode": "fade",
        "direction": "short",
        "drive_end": "09:45",
        "min_gap_pct": 0.0030,
    ...
    "both_gap_fade_drive15_rr15_session_open_stop": {
        "gap_mode": "fade",
        "direction": "both",
        "drive_end": "09:45",
        "min_gap_pct": 0.0030,
...
def evaluate_trades(
    ...
    row = {
        "symbol": symbol,
        "timeframe": timeframe,
        "strategy_family": "gap_continuation_fade",
        "variant": variant,
...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    safe = f"{args.symbol.upper()}_{args.timeframe}_{args.exit_policy}_gap_continuation_fade"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Gap Continuation/Fade diagnostic runner.")
    ...
    parser.add_argument("--output-dir", default="outputs/research/gap_continuation_fade")
