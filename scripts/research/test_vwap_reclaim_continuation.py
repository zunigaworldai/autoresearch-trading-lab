...
from strategies.vwap_reclaim_continuation import DEFAULT_PARAMS, generate_signals
...
VARIANTS = {
    "both_cross_rr15_atrstop": {
        "direction": "both",
        "reclaim_mode": "close_cross",
    ...
    "both_hold_rr15_vwapstop": {
        "direction": "both",
        "reclaim_mode": "two_bar_hold",
...
def evaluate_trades(
    ...
    row = {
        "symbol": symbol,
        "timeframe": timeframe,
        "strategy_family": "vwap_reclaim_continuation",
        "variant": variant,
...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    safe = f"{args.symbol.upper()}_{args.timeframe}_{args.exit_policy}_vwap_reclaim_continuation"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="VWAP reclaim / continuation diagnostic runner.")
    ...
    parser.add_argument("--output-dir", default="outputs/research/vwap_reclaim_continuation")
