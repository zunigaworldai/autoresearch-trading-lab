...
from strategies.liquidity_sweep_reversal import DEFAULT_PARAMS, generate_signals
...
VARIANTS = {
    "both_pd_sweep_reclaim_rr15_sweepstop": {
        "direction": "both",
        "entry_start": "09:45",
        "entry_end": "15:30",
    ...
    "long_pd_low_sweep_reclaim_rr15_sweepstop": {
        "direction": "long",
        "entry_start": "09:45",
        "entry_end": "15:30",
        "max_bars_after_sweep": 6,
    ...
    "short_pd_high_sweep_reclaim_rr15_sweepstop": {
        "direction": "short",
        "entry_start": "09:45",
        "entry_end": "15:30",
        "max_bars_after_sweep": 6,
    ...
    "both_pd_sweep_reclaim_rr2_sweepstop": {
        "direction": "both",
        "entry_start": "09:45",
        "entry_end": "15:30",
        "max_bars_after_sweep": 6,
    ...
    "both_pd_sweep_reclaim_rr15_atrstop": {
        "direction": "both",
        "entry_start": "09:45",
        "entry_end": "15:30",
        "max_bars_after_sweep": 6,
    ...
    "both_pd_sweep_reclaim_rr15_vwap": {
        "direction": "both",
        "entry_start": "09:45",
        "entry_end": "15:30",
    ...
    "both_pd_sweep_reclaim_rr15_ema": {
        "direction": "both",
        "entry_start": "09:45",
        "entry_end": "15:30",
        "max_bars_after_sweep": 8,
        ...
        "vol_mult": 1.00,
        "require_vwap_reclaim": False,
        "require_ema_reversal_alignment": True,
    },
}
...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    safe = f"{args.symbol.upper()}_{args.timeframe}_{args.exit_policy}_liquidity_sweep_reversal"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Previous-day liquidity sweep reversal diagnostic runner.")
    ...
    parser.add_argument("--output-dir", default="outputs/research/liquidity_sweep_reversal")
